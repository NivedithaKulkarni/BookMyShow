...
const BookShow = () => {
  ...
  const getData = async () => {
    try {
      ...
      const response = await getShowById({ showId: params.id });//get the show id from the db
      if (response.success) {
  ...
  return (
    <>
            ...
            >
              ...
              {selectedSeats.length > 0 && (
                <StripeCheckout
                  ...
                  //currency="INR"
                  stripeKey="pk_test_51RDNxWR7wf1HQrfcGkk6eIg126ZF6dSdrlqqy8rqyvyaHdQGDVuptk6lm5WbneWRgVeezkbVm7Hq0GR3JI6bzH6B00zdQ0HlkP"
      ...
      <style jsx>{`
        ...
        .legend-box.booked {
          background-color:rgb(15, 237, 45);
          border-color: #e0e0e0;
        }
