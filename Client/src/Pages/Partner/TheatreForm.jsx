    ...
    return(
        ...
        <Form layout='vertical' style={{width: "100%"}} initialValues={selectedTheatre} onFinish={onFinish}>
          <Row gutter={{
            ...
            <Col span={24}>
              <Form.Item label={<span className="custom-label">Theatre Name</span>}  htmlFor='name' name="name"  className='d-block'  rules={[{required: true, message: "Theatre name is required!"}]}>
                <Input id="name" type="text" placeholder='Enter the theatre name'></Input>
              </Form.Item>
            </Col>
            <Col span={24}>
              <Form.Item label={<span className="custom-label">Theatre Address</span>} htmlFor='address' name="address" className='d-block' rules={[{required: true, message: "Theatre name is required!"}]}>
            ...
            <Col span={24}>
              ...
              <Col span={12}>
                  <Form.Item  label={<span className="custom-label">Email</span>}  htmlFor='email' name="email" className='d-block' rules={[{required: true, message: "Email  is required!"}]}>
                        <Input id="email" type="email" placeholder='Enter the email'></Input>
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item  label={<span className="custom-label">Phone Number</span>}  htmlFor='phone' name="phone" className='d-block' rules={[{required: true, message: "Phone number is required!"}]}>
