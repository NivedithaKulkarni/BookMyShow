          ...
          >
            <Col span={24}>
              ...
              >
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Show Name</span>}
                    htmlFor="name"
                    name="name"
                    className="d-block"
                    rules={[
                ...
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Show Date</span>}
                    htmlFor="date"
                    name="date"
                    className="d-block"
                    rules={[
                      { required: true, message: "Show date is required!" },
                      {
                        validator: (_, value) => {
                          ...
                          if (selectedDate.isBefore(today)) {
                            return Promise.reject("Show date cannot be in the past!");
                          }
                ...
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Show Timing</span>}
                    htmlFor="time"
                    name="time"
                    className="d-block"
                    rules={[
            ...
            <Col span={24}>
              ...
              >
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Select the Movie</span>}
                    htmlFor="movie"
                    name="movie"
                    className="d-block"
                ...
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Ticket Price</span>}
                    htmlFor="ticketPrice"
                    name="ticketPrice"
                    className="d-block"
                    rules={[
                ...
                <Col span={8}>
                  <Form.Item
                    label={<span className="custom-label">Total Seats</span>}
                    htmlFor="totalSeats"
                    name="totalSeats"
                    className="d-block"
                    rules={[
