    ...
    >
      ...
      >
        ...
        >
          <Col span={24}>
            <Form.Item
              label={<span className="custom-label">Movie Name</span>}
              htmlFor="title"
              name="title"
              className="d-block"
          ...
          <Col span={24}>
            ...
            >
              <Col span={8}>
                <Form.Item
                  label={<span className="custom-label">Movie  Duration (in min)</span>}
                  htmlFor="duration"
                  name="duration"
                  className="d-block"
                  rules={[
              ...
              <Col span={8}>
                <Form.Item
                  label={<span className="custom-label">Movie Lanuage</span>}
                  htmlFor="language"
                  name="language"
                  className="d-block"
                  rules={[
              ...
              <Col span={8}>
                <Form.Item
                  label={<span className="custom-label">Release Date</span>}
                  htmlFor="releaseDate"
                  name="releaseDate"
                  className="d-block"
                  rules={[
          ...
          <Col span={24}>
            ...
            >
              <Col span={8}>
                <Form.Item
                  label={<span className="custom-label">Movie Genre</span>}
                  htmlFor="genre"
                  name="genre"
                  className="d-block"
                  rules={[
              ...
              <Col span={16}>
                <Form.Item
                  label={<span className="custom-label">Poster URL</span>}
                  htmlFor="poster"
                  name="poster"
                  className="d-block"
                  rules={[
